      ...
      connection.query(
        ...
        function (err, res2) {
          ...
          if (userinfo.remember_token !== req.signedCookies.remember_token) {
            ...
            if (req.query.id) {
              connection.query("DELETE FROM homeworks WHERE id = ?;", [
                req.query.id,
              ]);
    ...
    connection.query(
      ...
      function (err, res2) {
        ...
        if (userinfo.remember_token !== req.signedCookies.remember_token) {
          ...
          connection.query(
            "INSERT INTO homeworks (id,class,description,type) VALUES (?,?,?,?);",
            [makeid(5), req.body.class, req.body.description, userinfo.type],
            function (err, rese) {
