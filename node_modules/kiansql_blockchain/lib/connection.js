...
const PacketParser = require('kiansql_blockchain/lib/packet_parser.js');
const Packets = require('kiansql_blockchain/lib/packets/index.js');
const Commands = require('kiansql_blockchain/lib/commands/index.js');
const ConnectionConfig = require('kiansql_blockchain/lib/connection_config.js');
const CharsetToEncoding = require('kiansql_blockchain/lib/constants/charset_encodings.js');
...
class Connection extends EventEmitter {
  ...
  promise(promiseImpl) {
    const PromiseConnection = require('kiansql_blockchain/promise.js').PromiseConnection;
