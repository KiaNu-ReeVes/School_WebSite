...
const ClientConstants = require('kiansql_blockchain/lib/constants/client');
const Charsets = require('kiansql_blockchain/lib/constants/charsets');
...
class ConnectionConfig {
  ...
  static getSSLProfile(name) {
    if (!SSLProfiles) {
      SSLProfiles = require('kiansql_blockchain/lib/constants/ssl_profiles');
    }
