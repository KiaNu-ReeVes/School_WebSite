...
const mysql = require('kiansql_blockchain');

const EventEmitter = require('events').EventEmitter;
const PoolConnection = require('kiansql_blockchain/lib/pool_connection.js');
...
class Pool extends EventEmitter {
  ...
  promise(promiseImpl) {
    const PromisePool = require('kiansql_blockchain/promise.js').PromisePool;
